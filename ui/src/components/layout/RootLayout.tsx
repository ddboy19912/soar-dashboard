    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        ...
        <main className="pt-[141px] chromebook:pt-[101px] w-full">
          <div className="container mx-auto chromebook:mx-0 md:max-w-[720px] lg:max-w-full chromebook:max-w-[1190px] px-[25px] pt-[1px] pb-5 md:px-8 chromebook:px-10 chromebook:pt-6 chromebook:pb-[30px] overflow-x-visible">
            <Outlet />
          </div>
        </main>
      </div>
