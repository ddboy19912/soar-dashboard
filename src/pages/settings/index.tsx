  ...
  return (
    <div>
      <CustomCard
        ...
        contentClass="pt-[22px] pb-[37px] px-[30px]"
      >
        <Tabs defaultValue="edit-profile" className="w-full">
          <div className="w-full relative before:content-[''] before:block before:h-[1px] before:w-full before:bg-secondary-border before:absolute before:bottom-0 before:left-0">
            <TabsList className="bg-transparent p-0 h-full gap-[42px]">
              {tabsData.map((tab) => (
                <TabsTrigger
                  key={tab.value}
                  value={tab.value}
                  className="relative font-medium rounded-none px-4 py-[10px] data-[state=active]:bg-transparent data-[state=active]:shadow-none border-none text-base leading-[1.2] text-soft-blue data-[state=active]:text-active-link
